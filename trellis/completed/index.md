...
| [WTFM0009](tasks/WTFM0009.md) | Retarget the client runtime at @taprootio/espalier | Rename the client runtime's optional peer dependency and import from the legacy @taprootio/taproot-controls package to the public @taprootio/espalier name, so Espalier's repo can drop its GitHub Packages scope routing entirely. | 2026-07-23 |
